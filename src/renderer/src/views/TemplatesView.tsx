...
import { CircleAlert, ListOrdered, Mail, Paperclip, Plus, Save, Trash2, X } from 'lucide-react'
...
export default function TemplatesView(): React.JSX.Element {
  ...
  return (
    <div className="view">
      ...
      <div className="segment view-tabs" role="tablist" aria-label="템플릿 보기">
        <button
          role="tab"
        ...
        <button
          role="tab"
          aria-selected={tab === 'sequences'}
          className={tab === 'sequences' ? 'active' : ''}
          onClick={() => setTab('sequences')}
        >
          <ListOrdered size={14} /> 시퀀스
        </button>
      </div>
                  ...
                  >
                    <strong>
                      ...
                      {(t.attachments?.length ?? 0) > 0 && (
                        <span
                          className="side-attach"
                          title={`첨부 ${t.attachments?.length ?? 0}개`}
                        >
                          <Paperclip size={12} />
              ...
              <>
                ...
                <div className="form-field">
                  ...
                  <span className="hint-inline">
                    이 템플릿으로 만드는 모든 초안에 함께 첨부됩니다. 파일은 앱 데이터 폴더에
                    복사되어 보관됩니다.
                  </span>
                </div>
